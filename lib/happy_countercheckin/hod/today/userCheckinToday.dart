...
class UserCheckInToDay extends StatefulWidget {
  @override
  _UserCheckInToDayListState createState() => _UserCheckInToDayListState();
}

class _UserCheckInToDayListState extends State<UserCheckInToDay> {
  ...
  Future<void> readData() async {
    ...
    String empid = preferences.getString('empid');
    String url =
        '${MyConstantCounterCheckIN().domain}getUserCheckInToDay.php?select=true&empid=$empid';
      ...
      body: Column(
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: Row(
              children: <Widget>[
                Text("Check In".toUpperCase(), style: listtitleStyle),
                SizedBox(
                  width: 20,
                ),
              ],
  ...
  Widget showNoContent() {
    return loadProcess
        ...
        : Center(
            child: Text(
              'ไม่มีรายการผู้เข้ามาช่วยเหลืองานแผนกวันนี้',
              ...
              subtitle: Column(
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: managerCounterlists[index].ccLatCheackin == null ||
