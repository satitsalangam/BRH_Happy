...
class SideBarHodCheckIN extends StatefulWidget {
  @override
  _SideBarHodCheckINState createState() => _SideBarHodCheckINState();
}

class _SideBarHodCheckINState extends State<SideBarHodCheckIN>
    with SingleTickerProviderStateMixin<SideBarHodCheckIN> {
  bool loadUsers = true;
  Usermodel usermodel;
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            ListTile(
                              ...
                              subtitle:
                                  Text(department.toUpperCase(), style: depart),
                            ...
                            MenuItemCheckIN(
                              ...
                              onTap: () {
                                ...
                                BlocProvider.of<NavigationBloc>(context).add(
                                    NavigationEvents.MyHodIntroPageClickedEvent);
                              },
                            ),
                            // MenuItemCheckIN(
                            ...
                            //     onIconPressed();
                            //     BlocProvider.of<NavigationBloc>(context).add(
                            //         NavigationEvents.MyHistoryClickedEvent);
                            //   },
                            // ),
                            // Spacer(),
                            // Divider(
