...
class LocationInMaps extends StatefulWidget {
  final ManagerCounterList managerCounterlists;
  LocationInMaps({Key key, this.managerCounterlists}) : super(key: key);
  @override
  _LocationInMapsState createState() => _LocationInMapsState();
}

class _LocationInMapsState extends State<LocationInMaps> {
  ...
  void initState() {
    ...
    lat1 = double.parse(managerCounterList.ccLatCheackin);
    lng1 = double.parse(managerCounterList.ccLngCheackin);
