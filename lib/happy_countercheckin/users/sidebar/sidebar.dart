...
class SideBarCheckIN extends StatefulWidget {
  @override
  _SideBarCheckINState createState() => _SideBarCheckINState();
}

class _SideBarCheckINState extends State<SideBarCheckIN>
    with SingleTickerProviderStateMixin<SideBarCheckIN> {
  bool loadUsers = true;
  Usermodel usermodel;
