...
class UserInLoactionMaps extends StatefulWidget {
  final CounterCheackin counterCheackin;
  UserInLoactionMaps({Key key, this.counterCheackin}) : super(key: key);
  @override
  _UserInLoactionMapsState createState() => _UserInLoactionMapsState();
}

class _UserInLoactionMapsState extends State<UserInLoactionMaps> {
  ...
  void initState() {
    ...
    lat1 = double.parse(counterCheackins.ccLatCheackin);
    lng1 = double.parse(counterCheackins.ccLngCheackin);
    ...
    return Scaffold(
      body: Column(
        children: [
          ...
          lat1 == null ? MyStyle().showProgress() : Center(child: showMap()),
        ],
      ),
    );
  }
