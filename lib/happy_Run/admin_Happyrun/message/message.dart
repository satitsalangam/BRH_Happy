...
class _AdminMessageState extends State<AdminMessage> {
  ...
  Future<void> upload(String id) async {
    String nameImage = 'id.$id,message.png';
    print('name>>>>$nameImage, path>>>>${file.path}');

    String urlSaveFile = '${MyConstantRun().domain}saveMessage.php';
  ...
  Future<void> addMessageRun() async {
    print(title);
    print(detail);
    print(url);
    String urlmessage =
        '${MyConstantRun().domain}addMessage.php?isAdd=true&title=$title&detail=$detail&url=$url';
