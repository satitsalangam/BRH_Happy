...
import 'package:brhhappy/happy_Run/users/event/eventPhotoview.dart';
...
class ViewEventRun extends StatefulWidget {
  final Messagerun messagerun;
  ViewEventRun({Key key, this.messagerun}) : super(key: key);
  @override
  _ViewEventRunState createState() => _ViewEventRunState();
}

class _ViewEventRunState extends State<ViewEventRun> {
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) => MyViewPhotoEventRun(
                          messagerun: messageruns,
                        ),
                      ),
                    );
