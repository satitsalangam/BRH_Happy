...
class PopularAllBoy extends StatefulWidget {
  @override
  _PopularAllBoyState createState() => _PopularAllBoyState();
}

class _PopularAllBoyState extends State<PopularAllBoy> {
  ...
  Future<void> readData() async {
    String url = '${MyConstantRun().domain}getPopularAllMan.php?select=true';
