...
class PopularAllGirl extends StatefulWidget {
  @override
  _PopularAllGirlState createState() => _PopularAllGirlState();
}

class _PopularAllGirlState extends State<PopularAllGirl> {
  ...
  Future<void> readData() async {
    String url = '${MyConstantRun().domain}getPopularAllWoman.php?select=true';
