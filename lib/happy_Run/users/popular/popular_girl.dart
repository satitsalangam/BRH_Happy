...
class PopularGirl extends StatefulWidget {
  @override
  _PopularGirlState createState() => _PopularGirlState();
}

class _PopularGirlState extends State<PopularGirl> {
  ...
  Future<void> readData() async {
    ...
    String url = '${MyConstantRun().domain}getPopularWoman.php?select=true';
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [loadStatus ? MyStyle().showProgress() : showContent(size)],
    );
  }
